...
import Baner3 from "../../../public/banner-03.jpg"
...
export default function Category() {
    const year = new Date()
    return (
        <section className="w-full bg-[#121212] pb-14 pt-20">
            <div className="md:flex flex-wrap gap-8 px-4 lg:px-40">
                <div className="md:w-[45%] lg:flex-1 border border-[#e6e6e6] mx-auto">
                    <Link href="/" className="w-full h-full relative group overflow-hidden">
                        ...
                        <div className={`${popp.className} px-10 py-9 bg-[rgba(103, 117, 214, 0.0)] absolute top-0 left-0 group-hover:z-20`}>
                            <span className="text-2xl leading-4 text-[#FF5733] transition-all duration-500 pb-2 group-hover:text-[#fff] block font-bold">Women</span>
                            <span className="block text-xs leading-7 text-[#FF5733] transition-all duration-500 group-hover:text-[#fff]">Collection {year.getFullYear()}</span>
                        </div>
                ...
                <div className="md:w-[45%] lg:flex-1  border border-[#e6e6e6] mx-auto my-4 md:my-0">
                    <Link href="/" className="w-full h-full relative group overflow-hidden">
                        ...
                        <div className={`${popp.className} px-10 py-9 bg-[rgba(103, 117, 214, 0.0)] absolute top-0 left-0 group-hover:z-20`}>
                            <span className="text-2xl leading-4 text-[#FF5733] transition-all duration-500 pb-2 group-hover:text-[#fff] block font-bold">Men</span>
                            <span className="block text-xs leading-7 text-[#FF5733] transition-all duration-500 group-hover:text-[#fff]">Collection {year.getFullYear()}</span>
                        </div>
                        <div className={`${popp.className} px-10 py-9 bg-[rgba(103, 117, 214, 0.0)] absolute bottom-0 left-0 group-hover:z-20`}>
                            <div className="text-[15px] uppercase leading-6 transition-all duration-500 text-[#fff] transform translate-y-16 group-hover:translate-y-0">Shop Now</div>
                ...
                <div className="md:w-[45%] lg:flex-1  border border-[#e6e6e6] mx-auto">
                    <Link href="/" className="w-full h-full relative group overflow-hidden">
                        ...
                        <div className={`${popp.className} px-10 py-9 bg-[rgba(103, 117, 214, 0.0)] absolute top-0 left-0 group-hover:z-20`}>
                            <span className="text-xl leading-4 text-[#FF5733] transition-all duration-500 pb-2 group-hover:text-[#fff] block font-bold">Accessories</span>
                            <span className="block text-xs leading-7 text-[#FF5733] transition-all duration-500 group-hover:text-[#fff]">Collection {year.getFullYear()}</span>
                        </div>
                        <div className={`${popp.className} px-10 py-9 bg-[rgba(103, 117, 214, 0.0)] absolute bottom-0 left-0 group-hover:z-20`}>
                            <div className="text-[15px] uppercase leading-6 transition-all duration-500 text-[#fff] transform translate-y-16 group-hover:translate-y-0">Shop Now</div>
